...
public:
    ...
    std::shared_future<bool> enableAttrib(const Vop<gl::UInt>& index, const SrcLoc& loc = SrcLoc());
    std::shared_future<bool> disableAttrib(const Vop<gl::UInt>& index, const SrcLoc& loc = SrcLoc());
    ...
    std::shared_future<bool> setElementBuffer(const Buffer& buffer, const SrcLoc& loc = SrcLoc());
    std::shared_future<bool> setVertexBuffer(const Vop<gl::UInt>& binding, const Buffer& buffer,
