...
// void MeshVertexArray::_linkBuffer(const GL::ConstUint& index, const MeshAttribute& attr_buffer, const SrcLoc src_loc){
//     vao->setVertexBuffer(index, *attr_buffer.buffer, 0, attr_buffer.stride);
//     vao->setAttribFormat(index, attr_buffer.components, MeshAttribute::TypeToEnum(attr_buffer.type), attr_buffer.normalized, 0, src_loc);
// }
