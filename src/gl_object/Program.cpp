...
GL::GLstring Program::getInfoLog(const SrcLoc& src_loc){
    return _callGLCustom([](Gl& gl, const GLuint& id, const SrcLoc& src_loc){
        GLint len;
...
GL::GLint Program::getAttribLocation(const GLstring& name, const SrcLoc& src_loc){
    return _callGLCustom([](Gl& gl, const GLuint& id, const GLstring& name, const SrcLoc& src_loc){
        GLint loc;
...
void Program::bindAttribLocation(const GLuint& attr_index, const GLstring& name, const SrcLoc& src_loc){
    _callGL<&Gl::BindAttribLocation>(id(), attr_index, name, src_loc);
}

GL::GLint Program::getUniformLocation(const GLstring& name, const SrcLoc& src_loc){
    return _callGLCustom([](Gl& gl, const GLuint& id, const GLstring& name, const SrcLoc& src_loc){
        GLint loc;
...
GL::GLuint Program::getUniformBlockIndex(const GLstring& name, const SrcLoc& src_loc){
    return _callGLCustom([](Gl& gl, const GLuint& id, const GLstring& name, const SrcLoc& src_loc){
        GLuint loc;
