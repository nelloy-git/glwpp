...
ShaderBase::ShaderBase(const std::shared_ptr<Context>& ctx, const Enum& type, const SrcLoc& src_loc) :
...
void ShaderBase::source(const String& code, const SrcLoc& src_loc){
...
void ShaderBase::compile(const SrcLoc& src_loc){
    _callGL<&Gl::CompileShader>(id(), src_loc);
}



GL::Enum ShaderBase::getType(const SrcLoc& src_loc){
...
GL::Boolean ShaderBase::isCompiled(const SrcLoc& src_loc){
    return _callGLCustom([](Gl& gl, const Uint& id, const SrcLoc& src_loc){
        int dst;
...
GL::Int ShaderBase::getSourceLength(const SrcLoc& src_loc){
    return _callGLCustom([](Gl& gl, const Uint& id, const SrcLoc& src_loc){
        int dst;
...
GL::String ShaderBase::getInfoLog(const SrcLoc& src_loc){
    return _callGLCustom([](Gl& gl, const Uint& id, const SrcLoc& src_loc){
        int len;
