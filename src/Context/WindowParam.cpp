#include "Context/WindowParam.h"


// enum class WindowGLparam : GLenum {
//     BLEND = GL_BLEND,    // If enabled, blend the computed fragment color values with the values in the color buffers. See glBlendFunc.
//     CLIP_DISTANCE_0 = GL_CLIP_DISTANCE0, // If enabled, clip geometry against user-defined half space i.
//     CLIP_DISTANCE_1 = GL_CLIP_DISTANCE1, // If enabled, clip geometry against user-defined half space i.
//     CLIP_DISTANCE_2 = GL_CLIP_DISTANCE2, // If enabled, clip geometry against user-defined half space i.
//     CLIP_DISTANCE_3 = GL_CLIP_DISTANCE3, // If enabled, clip geometry against user-defined half space i.
//     CLIP_DISTANCE_4 = GL_CLIP_DISTANCE4, // If enabled, clip geometry against user-defined half space i.
//     CLIP_DISTANCE_5 = GL_CLIP_DISTANCE5, // If enabled, clip geometry against user-defined half space i.
//     CLIP_DISTANCE_6 = GL_CLIP_DISTANCE6, // If enabled, clip geometry against user-defined half space i.
//     CLIP_DISTANCE_7 = GL_CLIP_DISTANCE7, // If enabled, clip geometry against user-defined half space i.
//     CLIP_DISTANCE_NV = GL_CLIP_DISTANCE_NV, // If enabled, clip geometry against user-defined half space i.
