...
public:
    ...
    // EXPORT void GetUniformIndices(const Uint& program, const GLsizei& uniformCount, const GLchar& *const* uniformNames, const UintArr& uniformIndices, SrcLoc src_loc = SrcLoc{});
    // EXPORT void ShaderSource(const Uint& shader, const GLsizei& count, const GLchar& *const* string, const GLintArr& length, SrcLoc src_loc = SrcLoc{});
    // EXPORT void TransformFeedbackVaryings(const Uint& program, const GLsizei& count, const GLchar& *const* varyings, const GLenum& bufferMode, SrcLoc src_loc = SrcLoc{});
