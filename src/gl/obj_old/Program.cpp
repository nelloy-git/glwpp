...
bool Program::getUniformBlockLocation(Ptr<gl::UInt> dst, const Val<std::string>& name, const SrcLoc loc) const {
    return _executeGetter<CtxProgram, &CtxProgram::getUniformBlockLocation>(dst, name, loc);
}
