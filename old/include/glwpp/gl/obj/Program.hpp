...
public:
    ...
    bool setUniform_1I(const Val<const Int>& unif_loc, const Val<const Int>& data,
                       const Val<const Sizei>& count = 1, const Val<const utils::SrcLoc>& src_loc = utils::SrcLoc{});
